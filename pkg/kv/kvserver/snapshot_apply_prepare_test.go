...
func TestPrepareSnapApply(t *testing.T) {
	...
	swb := snapWriteBuilder{
		...
		subsume: []kvstorage.DestroyReplicaInfo{
			{FullReplicaID: roachpb.FullReplicaID{RangeID: descA.RangeID, ReplicaID: replicaID}, desc: descA},
			{FullReplicaID: roachpb.FullReplicaID{RangeID: descB.RangeID, ReplicaID: replicaID}, desc: descB},
		},
	}
